...
Версия 0.5.9 добавляет русские подписи и правила подтверждения для первых
кнопок управления. Версия 0.5.8 добавила точное описание их входных данных, а
версия 0.5.7 полностью перевела пользовательские названия,
пояснения, ошибки и результаты проверок на понятный русский язык.
