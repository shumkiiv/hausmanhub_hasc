...
CONTRACT_PATHS = tuple(
    ...
    for name in (
        ...
        "climate-reference-suite.schema.json",
...
REQUIRED_PACKAGE_PATHS = (
    ...
    INTEGRATION_DIRECTORY / "application/climate_demands.py",
    INTEGRATION_DIRECTORY / "application/climate_equipment.py",
    INTEGRATION_DIRECTORY / "application/climate_observations.py",
    INTEGRATION_DIRECTORY / "application/climate_resolutions.py",
    INTEGRATION_DIRECTORY / "application/climate_targets.py",
    INTEGRATION_DIRECTORY / "application/climate_discovery.py",
    INTEGRATION_DIRECTORY / "application/climate_native_projections.py",
    INTEGRATION_DIRECTORY / "application/climate_native_setup.py",
    ...
    INTEGRATION_DIRECTORY / "domain/climate_demand.py",
    INTEGRATION_DIRECTORY / "domain/climate_equipment.py",
    INTEGRATION_DIRECTORY / "domain/climate_observation.py",
    INTEGRATION_DIRECTORY / "domain/climate_reference.py",
    INTEGRATION_DIRECTORY / "domain/climate_resolution.py",
    INTEGRATION_DIRECTORY / "domain/climate_targets.py",
