...
Версия документа: 2026-07-18. Реализация относится к HASC 0.5.9.
...
распознавания старых ответов. В 0.5.9 актуальный Android home-контракт находится
...
1. Установить HASC 0.5.9, оставить climate bridge в `disabled`.
...
0.5.9 подготавливает для Android публичный home v4 со статусом кнопок,
