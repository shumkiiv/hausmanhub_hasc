"""One-shot read-only import of the retired external climate API contract.

Roadmap item 37. This parser exists only for the migration wizard: it
validates and reduces the legacy state snapshot for the one-shot import.
It is not a runtime dependency and never drives live reads outside the
